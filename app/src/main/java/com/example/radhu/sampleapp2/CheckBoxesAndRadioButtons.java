package com.example.radhu.sampleapp2;
...
public class CheckBoxesAndRadioButtons extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                StringBuffer check4Result = new StringBuffer();
                if(check4.isChecked()) {
                    check4Result.append("Holden: Selected");
                    Toast.makeText(CheckBoxesAndRadioButtons.this, check4Result.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        radio4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                StringBuffer radio4Result = new StringBuffer();
                if(radio4.isChecked()) {
                    radio4Result.append("Green: Selected");
                    Toast.makeText(CheckBoxesAndRadioButtons.this, radio4Result.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(radio4.getId() == selectedRadioButtonId)
                    result.append("Green: Selected ");
